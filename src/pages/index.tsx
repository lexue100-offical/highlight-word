...
type Props = {
  ...
  seniorData: TextData;
  easyData: TextData;
  gradeOneFirstData: string[];
  gradeOneSecondData: string[];
  gradeTwoFirstData: string[];
  gradeTwoSecondData: string[];
  gradeThreeFirstData: string[];
  gradeThreeSecondData: string[];
  gradeFourFirstData: string[];
  gradeFourSecondData: string[];
  gradeFiveFirstData: string[];
  gradeFiveSecondData: string[];
  gradeSixFirstData: string[];
  gradeSixSecondData: string[];
};
      ...
      <main className="container mx-auto flex min-h-screen flex-col items-center justify-center space-y-2 p-4">
        ...
        <section className="flex w-full space-x-2">
          <textarea
            ...
            className="resize-none rounded border border-red-300 bg-red-50 p-3 text-slate-400 focus:outline-none overflow-y-scroll no-scrollbar"
          ></textarea>
